"""
Not my work. Downloaded from https://github.com/alpacahq/example-portfolio-manager
Added functionality to the constructor, to support paper accounts (no real money)
...
class PortfolioManager():
    def __init__(self, paper_account=False):
        if paper_account:
